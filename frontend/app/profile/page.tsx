                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Получать уведомления о дедлайнах на email</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          <input
                    ...
                    <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            <h3 className="font-semibold text-gray-900">Telegram уведомления</h3>
                            <p className="text-sm text-gray-600">Получать уведомления в Telegram боте</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          <input
